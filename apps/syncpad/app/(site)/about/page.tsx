        ...
        <div className="space-y-xl bg-page-gradient-purple py-40">
            <section className="container max-w-screen-md space-y-sm text-color-primary-text">
                ...
                <div className="prose prose-invert prose-headings:text-white prose-a:text-blue-400 prose-strong:text-white prose-code:text-pink-400 max-w-none lg:text-xl">
                    <p>
                        <strong>syncpad</strong> is a web-based collaborative whiteboard
                    ...
                    <p>
                        syncpad is built with <strong>privacy by design</strong> to ensure
                    ...
                    <pre>
                        <code>https://syncpad.app/#room=abc123,xyz456</code>
                    </pre>
                    <ul className="flex flex-col gap-1">
                    ...
                    <ul className="flex flex-col gap-1">
                        ...
                        <li>
                            Works like <strong>syncpad&apos;s E2EE rooms</strong>, but tailored for your logic
                        </li>
                    </ul>
                    ...
                    <p>
                        <a href="https://github.com/Debjyoti2004/SyncPad-v2.git" target="_blank" rel="noopener noreferrer">
                            github.com/Debjyoti2004/syncpad
                        </a>
                    </p>

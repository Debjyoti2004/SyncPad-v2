...
export function MainMenuWelcome() {
    return (
        <div className="collabyfont welcome-screen-decor welcome-screen-decor-hint welcome-screen-decor-hint--menu">
            ...
            <div className="welcome-screen-decor-hint__label font-collabyfont">Export, preferences, languages, ...</div>
        </div>
    )
}
...
export function ToolMenuWelcome() {
    return (
        <div className="collabyfont z-[4] welcome-screen-decor welcome-screen-decor-hint welcome-screen-decor-hint--toolbar">
    ...
    return (
        <>
            <div className="welcome-screen-center z-[3]">
                <div className="welcome-screen-center__logo collabyfont welcome-screen-decor">
                    <div className="syncpadLogo is-small">
                        {/* <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="syncpadLogo-icon">
                        ...
                        <h1 className="brand-title syncpadLogo-text font-collabyfont">syncpad</h1>
                    </div>
                </div>
                <div className="welcome-screen-center__heading welcome-screen-decor font-collabyfont">All your data is saved locally in your browser.</div>
